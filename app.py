...
def process_message(message):
    """Process chat messages using OpenAI and handle calendar-related commands"""
    # First check for direct calendar commands
    ...
    try:
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": """You are a helpful calendar assistant. You can help users manage their calendar events, 
                schedule meetings, and provide information about their schedule. Keep responses concise and focused on calendar-related tasks."""},
